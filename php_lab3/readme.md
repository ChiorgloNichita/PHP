```markdown
# Лабораторная работа: Разработка системы для работы с банковскими транзакциями и галереей изображений

## Описание

В данной лабораторной работе разработана веб-страница, которая включает два основных компонента:
1. Систему отображения банковских транзакций с возможностью вычисления общей суммы транзакций.
2. Галерею изображений, выводимую с помощью PHP и HTML.
...
2. Переместите фотографии в папку **image/**.
3. Откройте файл **index.php** в вашем веб-браузере через локальный сервер (например, используя XAMPP или другой сервер PHP).
